...
about: {
  ...
  summary:
    "Simulating network reconnaissance from Kali Linux against Metasploitable2 and investigating how the activity appears across Security Onion, Zeek, Suricata, pfSense firewall telemetry and Wazuh.",

  findings: [
    "The experiment is designed to compare how the same reconnaissance activity appears from both offensive and defensive perspectives.",
    "Nmap will be used for host discovery, port scanning, service enumeration and operating system fingerprinting against Metasploitable2.",
    "Zeek connection telemetry will be reviewed to identify communication between the Kali Linux source and the vulnerable target.",
    "Suricata alerts will be reviewed where the reconnaissance activity matches enabled detection signatures.",
    "pfSense firewall logs will be reviewed to identify inter-VLAN connections generated during the reconnaissance activity.",
  ...
  lessons: [
    ...
    "Nmap provides multiple techniques for discovering hosts, ports, services and operating system information.",
    "The same activity can produce different evidence depending on whether it is viewed from the attacker, network sensor, firewall or endpoint perspective.",
    "Zeek can provide detailed network metadata even when an activity does not generate a traditional security alert.",
    "Suricata provides signature-based detection where scanning behaviour matches configured rules.",
    "Correlating timestamps, source addresses, destination addresses, ports and protocols across multiple platforms is an important part of incident investigation.",
    "MITRE ATT&CK provides a useful framework for mapping observed activity to known adversary techniques."
  ],

  body: [
    "Phase 1 of the cybersecurity lab focuses on network discovery and reconnaissance. The first experiment introduces controlled scanning against an intentionally vulnerable Linux system using Kali Linux and Nmap.",
    ...
    "The defensive side of the experiment focuses on observing the same activity through Security Onion. Zeek telemetry will be used to identify connections between Kali Linux and Metasploitable2, while Suricata will be reviewed for any reconnaissance or scanning alerts generated by the activity.",

    "Because the reconnaissance traffic crosses segmented lab networks, pfSense firewall telemetry will also be reviewed to identify connections between the Kali Linux source and the vulnerable target. Where applicable, Wazuh telemetry will be checked for related endpoint or system events.",

    "The investigation will compare timestamps, source and destination addresses, ports, protocols and identified services across the different platforms. This creates an attack-to-detection workflow where activity generated from Kali Linux can be followed through the defensive monitoring environment.",
    ...
    "Once the experiment is completed, this entry will be updated with the actual Nmap results, Zeek telemetry, Suricata observations, pfSense firewall logs, Wazuh evidence and conclusions from the investigation."
  ],

  images: [
    {
      src: "assets/images/recon-nmap-discovery.png",
      alt: "Nmap network reconnaissance from Kali Linux against Metasploitable2",
      caption:
        "Kali Linux performing controlled network reconnaissance against the Metasploitable2 target.",
      afterParagraph: 2
    },

    {
      src: "assets/images/recon-security-onion.png",
      alt: "Security Onion telemetry showing network reconnaissance activity",
      caption:
        "Security Onion used to correlate Zeek network telemetry and any Suricata detections generated during the reconnaissance activity.",
      afterParagraph: 3
    },

    {
      ...
      caption:
        "pfSense firewall telemetry reviewed to validate inter-VLAN connections between the reconnaissance source and vulnerable target.",
      afterParagraph: 4
    }
  ]
},
